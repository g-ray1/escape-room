      ...
      <div className="container">
        ...
        <div className="cards-grid">
          ...
          <div className="quest-card">
            <div className="quest-card__img">
              <picture>
                ...
                />
                <img
                  src="img/content/ritual/ritual-size-s.jpg" srcSet="img/content/ritual/ritual-size-s@2x.jpg 2x"
          ...
          <div className="quest-card">
            <div className="quest-card__img">
              <picture>
                ...
                />
                <img
                  src="img/content/ghosts/ghosts-size-s.jpg" srcSet="img/content/ghosts/ghosts-size-s@2x.jpg 2x"
          ...
          <div className="quest-card">
            <div className="quest-card__img">
              <picture>
                ...
                />
                <img
                  src="img/content/hut/hut-size-s.jpg" srcSet="img/content/hut/hut-size-s@2x.jpg 2x" width="344"
          ...
          <div className="quest-card">
            ...
            <div className="quest-card__content">
              <div className="quest-card__info-wrapper">
                <a className="quest-card__link" href="quest.html">Фатальный эксперимент
                </a>
              </div>
              <ul className="tags quest-card__tags">
                <li className="tags__item">
          ...
          <div className="quest-card">
            <div className="quest-card__img">
              <picture>
                ...
                />
                <img
                  src="img/content/metro/metro-size-s.jpg" srcSet="img/content/metro/metro-size-s@2x.jpg 2x" width="344"
                  height="232" alt="Мужчина на фоне кирпичной стены."
                />
              </picture>
            </div>
            <div className="quest-card__content">
          ...
          <div className="quest-card">
            <div className="quest-card__img">
              <picture>
                ...
                />
                <img
                  src="img/content/loft/loft-size-s.jpg" srcSet="img/content/loft/loft-size-s@2x.jpg 2x" width="344"
            ...
            <div className="quest-card__content">
              <div className="quest-card__info-wrapper">
                <a className="quest-card__link" href="quest.html">Старый чердак</a>
              </div>
              <ul className="tags quest-card__tags">
                <li className="tags__item">
                  <svg width="11" height="14" aria-hidden="true">
          ...
          <div className="quest-card">
            <div className="quest-card__img">
              <picture>
                ...
                />
                <img
                  src="img/content/mars/mars-size-s.jpg" srcSet="img/content/mars/mars-size-s@2x.jpg 2x" width="344"
